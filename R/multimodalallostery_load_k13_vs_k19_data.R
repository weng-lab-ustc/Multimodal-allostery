#' load k13 vs k19 data
#'
#' Workflow-only September 2026 implementation of `multimodalallostery_load_k13_vs_k19_data()`.
#'
...
#' @export
multimodalallostery_load_k13_vs_k19_data <- function (input_k13, input_k19, anno, binding_sites_map = list(RAF1 = c(21, 25, 29, 31, 33, 36, 37, 38, 39, 40, 41, 67, 71), 
        ...
        98, 99, 101, 102, 105, 107, 108, 125, 129, 133, 136, 137)), fixed_threshold = 0.40000000000000002) 
{
    ...
    cat("\nK13 vs K19 thresholds:\n")
    cat("  K13 threshold:", prepared$threshold_x, "\n")
    cat("  K19 threshold:", prepared$threshold_y, "\n")
    return(list(data = prepared$data, threshold_K13 = prepared$threshold_x, threshold_K19 = prepared$threshold_y))
}
