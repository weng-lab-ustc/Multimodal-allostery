...
#' @export
multimodalallostery_prepare_mapped_merged_data_with_fdr <- function(input_x, input_y, assay_x, assay_y, anno, binding_sites_map) {
    data_x <- multimodalallostery_load_mapped_mutation_data(input_x, assay_x)
    data_y <- multimodalallostery_load_mapped_mutation_data(input_y, assay_y)
