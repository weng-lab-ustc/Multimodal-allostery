...
#' @export
multimodalallostery_plot_fitness_correlation_blocks_BI2 <- function(input, assay_name, colour_scheme) {
    d <- GGally::ggpairs(input, columns = c(18, 19, 20), columnLabels = c("replicate 1", "replicate 2", "replicate 3"), mapping = ggplot2::aes(color = block), 
