#' prepare pairwise merged data with fdr
#'
#' Workflow-only September 2026 implementation of `multimodalallostery_prepare_pairwise_merged_data_with_fdr()`.
#'
...
#' @export
multimodalallostery_prepare_pairwise_merged_data_with_fdr <- function (input_x, input_y, assay_x, assay_y, anno, fixed_threshold = 0.40000000000000002, binding_sites_map = list(RAF1 = c(21, 
