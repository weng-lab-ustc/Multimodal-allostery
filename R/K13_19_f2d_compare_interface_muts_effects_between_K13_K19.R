...
# ===== Read data =====
ddG1 <- krasddpcams__read_ddG(ddG = "C:/Users/36146/OneDrive - USTC/DryLab/MoCHI_8binders_l2_e6_RA_old_new_merge_at_mochi_20260104_lr_0.025_2048/task_901/weights/weights_Binding_K13.txt", assay_sele = "K13")
ddG2 <- krasddpcams__read_ddG(ddG = "C:/Users/36146/OneDrive - USTC/DryLab/MoCHI_8binders_l2_e6_RA_old_new_merge_at_mochi_20260104_lr_0.025_2048/task_901/weights/weights_Binding_K19.txt", assay_sele = "K19")

K13_binding_interface_site <- c(98, 107, 101, 102, 99, 136, 95, 137, 94, 133, 90, 129, 87, 91, 88)
K19_binding_interface_site <- c(98, 107, 101, 102, 99, 136, 95, 137, 94, 133, 90, 129, 87, 91, 88)

ddG1_K13 <- ddG1[Pos_real %in% K13_binding_interface_site, c(1:3, 23:27)]
ddG2_K19 <- ddG2[Pos_real %in% K19_binding_interface_site, c(1:3, 23:27)]
...
ddG_dc <- merge(ddG1_dc, ddG2_dc, by = c("mt", "Pos_real"), all = F)

# ===== Calculate correlation =====
cor_test <- cor.test(ddG_dc$K13, ddG_dc$K19, use = "complete.obs")
...
cat("Sample size (n) =", cor_test$parameter + 2, "\n")

# ===== Identify points deviating from correlation =====
# 1. Linear fitting
fit <- lm(K19 ~ K13, data = ddG_dc)
ddG_dc <- ddG_dc[complete.cases(ddG_dc[, c("K13", "K19")]), ]
...
# Save plot
ggplot2::ggsave("C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/20260521_start_Updating/result2_figure2/scatter_plot_compare_K13_K19_binding_interface_label_outlier_per_mutations.pdf", 
